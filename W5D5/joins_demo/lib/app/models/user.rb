class User < ApplicationRecord
  ...
  def n_plus_one_post_comment_counts
    posts = self.posts # Gets all of this User's posts
    # SELECT *
    #   FROM posts
    ...
    post_comment_counts = {} # post => comment count
    posts.each do |post| # For each post, store its number of comments in a hash
